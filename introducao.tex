...
Para o presente trabalho, definiu-se que o foco estará nos aspectos de qualidade na orientação a serviços, sobretudo no que se 
refere aos resultados obtidos. Com essa decisão entende-se que o SOC já atingiu patamares elevados de funcionalidade por meio de padrões e especificações, arquiteturas e processos. 
...
Objetiva-se também obter melhores definições acerca da história recente e das atuais tendências para a arquitetura orientada a serviços, ou SOA, uma vez que há indícios preliminares de que o termo, após grande ênfase tanto por parte de pesquisadores quanto por parte de vendedores, vem sendo menos referenciado na TI. Em contrapartida, deseja-se também mapear a evolução das pesquisas relacionadas ao Cloud Computing, termo que também é abrangido pela computação orientada a serviços.

Conjuntamente, também é objetivo que este estudo sirva de embasamento para posteriores trabalhos de pesquisa, uma vez que a metodologia utilizada tem um caráter exploratório e anterior a estudos mais específicos.
