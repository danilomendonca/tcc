...
Vários princípios de design regem a confecção dos serviços e de seus inventários. 
...
Um dos maiores revezes dos SRs está no esforço considerável por ele requerido \cite{Petersen_Feldt_Mujtaba_Mattsson_2007}. Dada a vastidão de tópicos abordados pela computação orientada a objetos, é factível supor que um trabalho de SR se tornaria inviável devido ao elevado número de estudos publicados e um número reduzido de pessoal responsável pela suas análises, uma vez que deseja-se obter um panorama geral ou especificando tópicos de grande amplitude.

Um Mapping Study é designado para prover uma ampla visão de determinada área de pesquisa, para verificar se indícios de pesquisa existem em determinados tópicos e prover indicações quantitativas das evidências. \cite{Kitchenham_Charters_2007}. 

O MS segue um processo sistêmico que visa garantir um nível de qualidade adequado aos resultados obtidos. Algumas passos são diretamente herdados dos SRs, enquanto outros são suprimidos ou adaptados para se garantir a viabilidade de seus objetivos. Cada passo do processo de mapeamento irá gerar um resultado, sendo o resultado final o mapeamento propriamente dito \cite{Petersen_Feldt_Mujtaba_Mattsson_2007}.



Para o presente trabalho, definiu-se que o foco irá tratar de aspectos de qualidade na orientação a serviços, sobretudo no que se 
refere aos resultados obtidos. Com essa decisão entende-se que o SOC já atingiu patamares elevados de funcionalidade por meio de padrões e especificações, arquiteturas e processos. Segundo \cite{Papazoglou:2007:SOA:1265289.1265298}, devido ao crescente acordo na implementação e gerência de aspectos funcionais de serviços, tal qual a adoção de WSDL para a descrição, SOAP para troca de mensagens, ou WS-BPEL para a composição, os interesses de pesquisadores estão se voltando aos aspectos não funcionais de aplicações orientadas a serviços. 