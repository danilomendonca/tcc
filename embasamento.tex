...
Os princípios adotados pelo service oriented design são aqueles adotados pela arquitetura orientada a objetos. Dado seu peso e complexidade, a aplicação escalonável desses princípios à realidade de cada organização se faz necessária de modo a evitar um colapso da estrutura existente devido aos altos custos envolvidos em sua adoção e à necessidade de uma profunda reestruturação da TI.
