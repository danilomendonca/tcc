...
A orientação a objetos também teve grande influência na orientação a serviços. Muitos conceitos por ela reforçados tem precedência nesse paradigma, entre eles o alinhamento do modelo de negócio e da TI, visto que as classes são moldadas à partir de conceitos e objetos reais, o aumento da robustez, uma vez que a orientação a objetos mantém um forte processo de design da solução com uso de diagramas UML, possui um complexo modelo para exceções e rotinas de teste, da extensibilidade, haja vista a característica modular das classes e as diversas possibilidades de herança, polimorfismo e associações capazes de estender o escopo da solução, da flexibilidade, dado o uso de encapsulamento e abstração, sendo possível a adaptação do funcionamento a novas realidades, e por fim da reusabilidade e da produtividade, dada a existência de classes abstratas e de códigos genéricos e reutilizáveis 2007:SPS:1296147}.

Várias abstrações permeiam ambos os paradigmas. A unidade coesa representada por classes e suas instâncias, os objetos, podem ser diretamente comparadas com a abstração de serviços, uma vez que esses também representam unidades lógicas coesas e cuja instância irá atender a um conjunto bem definido de funcionalidades. 
