...
\subsection{Definição das Classificações e Extração de Dados}
...
Durante a abordagem de cada publicação, é importante tomar notas explicativas justificando a classificação realizada em cada categoria. Isso auxilia tanto o responsável pela classificação quanto aqueles que posteriormente também passarem pela classificação da mesma publicação ou que servirem de revisores para o mapeamento, reduzindo possíveis desvios. Para tanto, é indispensável o uso de ferramentas que organizem as informações colhidas e anotadas, de preferência com acesso gráfico e de boa usabilidade.

\subsection{Mapeamento Sistemático de Estudos}

Após a classificação dos dados...