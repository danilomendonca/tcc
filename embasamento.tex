...
\subsubsection{Escolha das Perguntas de Pesquisa}
...
\subsubsection{Pesquisa primária}
...
Uma abordagem metódica para a construção da \textit{string} de busca consiste na definição de 

%Figura com escopo da orientação a objetos e a serviços
\begin{figure}[hbtp]
	\centering	\includegraphics[width=0.9\textwidth]{figs/danilo/Mapping_Process.eps}
	\caption{Processo para o Systematic Mapping Study}	
