...
\titulolinhai{A Systematic Mapping Study:}
...
\autori{Danilo Filgueira Mendonça}
...
\titulominusculoi{A Systematic Mapping Study: }
\titulominusculoii{QOS em Computação Orientada a Serviços}
\refautori{MENDONCA, D. F.}
\refautorii{}
\numpaginastexto{52p}
...
\dedicatoriaautori{Às manhãs de meu avô.}

% Texto de dedicatória do segundo autor. Caso não tenha um segundo autor, este texto não
% será mostrado
%\dedicatoriaautorii{Dedico este trabalho aos meus pais que sempre me deram apoio e acreditaram no meu esforço para que eu concluísse meu curso de graduação}
...
% será mostrado
%\agradecimentosautorii{Agradeço a todos meus amigos que entraram comigo no curso em especial ao Roberto Braga que comigo fez este trabalho de conclusão de curso. A todos com quem trabalhei no TCU, principal ao Geraldo Magela, que me deu a oportunidade de estagiar no SIRED e ao Alfram Albuquerque que propôs este projeto e foi de fundamental importância para o andamento e conclusão do projeto.
%Ao meu orientador, Rafael Timóteo, por aceitar o tema do projeto e acreditar na conclusão deste trabalho. }
